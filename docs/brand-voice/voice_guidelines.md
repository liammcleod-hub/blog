...
| ✅ Do | ❌ Don't |
|-------|---------|
| "Was wirst du diesen Frühling erschaffen?" | "Q4 ist für uns die umsatzstärkste Zeit" |

> See [[forbidden_phrases]] for business interiority language to never use.
...
> See [[tone_doc]] for calibrations on intimacy dimension.
...
> See [[marketing-handbook]] for how this plays out in customer service and abandoned cart emails.
...
> See [[bastelschachtel-soul-first]] for examples of implicit selling in action.
...
> See [[BASTELSCHACHTEL-BRAND-VOICE]] for complete signature guide.
...
> See [[example_subject]] for subject line examples by type.
> See [[bastelschachtel-soul-first]] for real emails showing each type.
