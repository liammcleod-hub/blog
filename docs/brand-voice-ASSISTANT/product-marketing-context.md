...
| Category | Files |
|----------|-------|
| **Core Brand Voice** | [[BASTELSCHACHTEL-BRAND-VOICE]] · [[brand_guidelines]] · [[tone_doc]] · [[voice_guidelines]] · [[forbidden_phrases]] |
| **Live Examples** | [[bastelschachtel-soul-first]] · [[example_subject]] |
| **Reference** | [[marketing-handbook]] |
...
- Review-derived friction themes:
  ...
  - "Leicht wird das A3-Format geknickt und nicht gerollt verschickt"
...
|----------|------|-------------|
| SEO README | [[docs/seo/README]] | SEO documentation index |
| Customer Reviews README | [[docs/customer-reviews/README]] | VOC documentation index |
| Blogs Skill Guide | [[docs/reference/skill-guides/blogs]] | Blog content guides |
...
| VOC Product Family | [[docs/customer-reviews/voc-product-family]] | VOC by product |
| Competitor Analysis | [[docs/seo/competitor-analysis]] | Competitive landscape |
