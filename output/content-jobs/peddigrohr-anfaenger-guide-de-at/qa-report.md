...
- Where: strength guidance and recommendation table, plus the project recommendation section in `article-revised.html`
- Problem: the article’s pairings are coherent for a beginner guide, but `selected-products.json` does not carry enough technical product detail to fully prove statements like which project is the better first step or when 3mm is the better choice.
...
- Where: the `Peddigrohr oder Holzschliff` section in `article-revised.html`
